...
app.controller('SiteIndexCtrl', function($scope, $element, WindowInfo) {
  ...
  $scope.joinAppAndStart = function() {
    return StartApp.run($scope.project_path, function(data) {
      return $scope.$broadcast('console:message', data);
    });
  };
  $scope.createSchemas = function() {
    return CreateSequelize.createSchemas($scope.project_path, function(data) {
      return $scope.$broadcast('console:message', data);
    });
  };
  $scope.createModels = function() {
    return CreateSequelize.createModels($scope.project_path, function(data) {
      return $scope.$broadcast('console:message', data);
    });
  };
  $scope.createRouters = function() {
    return CreateSequelize.createRouters($scope.project_path, function(data) {
      return $scope.$broadcast('console:message', data);
    });
  };
  $scope.createModelTests = function() {
    return CreateSequelize.createModelTests($scope.project_path, function(data) {
      return $scope.$broadcast('console:message', data);
    });
  };
  $scope.runTest = function(params) {
    return RunTest.run($scope.project_path, params, function(data) {
      return $scope.$broadcast('console:message', data);
    });
  };
  ...
  return $scope.getTestTree = function() {
    return RunTest.getTestTree($scope.project_path).then(function(res) {
